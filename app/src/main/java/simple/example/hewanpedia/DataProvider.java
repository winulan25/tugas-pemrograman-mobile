...
public class DataProvider {
    ...
    private static List<Burung> initDataBurung(Context ctx) {
        ...
        burungs.add(new Burung("jalak", "kalimantan",
                "burung yang umumnya berukuran sedang (sekitar 20-25 cm) gagah, dengan paruh yang kuat, tajam dan lurus;", R.drawable.burung_jalak));
        burungs.add(new Burung("ciblek", "Indonesia ",
                "burung kecil ramping dengan panjang total (diukur dari ujung paruh hingga ujung ekor) sekitar 13cm. hampir seluruh sisi atas badan berwarna coklat hijau-zaitun. tenggorokan dan dada putih, perut dan pantat kekuningan", R.drawable.burung_ciblek));
        burungs.add(new Burung("cucuk rawa", "Indonesia",
                "burung yang berukuran sedang, panjang tubuh total (diukur dari ujung paruh hingga ujung ekor) sekitar 28cm.", R.drawable.burung_cucukrawa));
        burungs.add(new Burung("pleci", "jawa",
                "panjang tubuhnya (diukur dari ujung paruh hingga ujung ekor) berkisar antara 8-15cm.ciri yang paling jelas adalah adanya lingkaran putih yang mengelilingi mata,meskipun ada beberapa jenisnya yang tidak memilikinya.", R.drawable.burun_pleci));
        burungs.add(new Burung("kenari", "jawa",
                "burung kecil yang bersuara merdu dan berbulu kuning yang indah", R.drawable.burung_kenari));
        burungs.add(new Burung("kecer", "indonesia",
                "burung ini berwarna hitam dan putih dengan ekor yang panjang. ekornya terangkat ke atas jika mereka sedang mencari makanan ditanah atau kadang ketika sedang bertengger", R.drawable.burung_kecer));
        return burungs;
    }
